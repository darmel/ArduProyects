...
int calibracion1()
  {
    sensorValue = analogRead(sensor1); //leo el sensor (A1)
    ...
    ldd1=(sensorMax-sensorMin)/2;
  }

int calibracion2()
  {
    sensorValue = analogRead(sensor2); //leo el sensor (A2)
    ...
    ldd2=(sensorMax-sensorMin)/2;
  }

int calibracion3()
  {
    sensorValue = analogRead(sensor3); //leo el sensor (A0)
